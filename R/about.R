  ...
  div(class="about",
      ...
      fluidRow(
        column(12,
               ...
               HTML("<p><b>Please upvote this app at: </b><a href='https://community.rstudio.com/t/shiny-contest-submission-city-cycle-race-with-strava-compare-the-cycling-speed-of-cities/25112'>R Shiny Contest</a> if you like it</p>"),
               column(12,
